...
const Navbar = () => {
  ...
  return (
    <div className="w-full fixed z-10 text-white">
      <div>
        <div className="flex flex-row justify-between p-5 md:px-32 px-4 bg-backgroundColor shadow-[rgba(0,_0,_0.24)_0px_3px_8px]">
          <div className="flex flex-row items-center cursor-pointer">
            <Link>
              <h1 className="text-2xl font-semibold">Littafi</h1>
            </Link>
          </div>
